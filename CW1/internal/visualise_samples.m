function visualise_samples(idx_best,data,dim,t,ig_best,N,idx) % Draw the split line
...
C = length(unique(idx))/length(idx)*100;
title(sprintf('Sample %i. Uniqueness = %4.2f%%',dim,C));
